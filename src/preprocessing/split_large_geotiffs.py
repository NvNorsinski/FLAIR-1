...
def split(file_name, n):
    ...
    output_path = os.path.join(output_dir, raw_file_name)
    if not os.path.exists(output_path):
        os.makedirs(output_path)

    print ("GCD", (round(width, 0), round(height, 0)))
    print ("Width", width)
    print ("height", height)
    ...
    for tile in tiles:
        ...
        output_file = os.path.join(output_dir, raw_file_name, output_file_base)
        print(output_file)
